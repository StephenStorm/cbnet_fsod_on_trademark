...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale = [(1536, 1024), (1760, 1173), (1984, 1322), (2208, 1472), (2432, 1620), (2656, 1770), (2880, 1920)],
        img_scale = [(1536, 1024), (1696, 1130), (1856, 1236), (2016, 1342), (2176, 1448), (2336, 1554), (2496, 1664)],
        flip=True,
        transforms=[
...
fp16 = None
gpu_ids = range(0, 8)
work_dir = './work_dirs/cascade_mask_rcnn_cbv2_swin_base_cp_mixup0.5_affine_freeze_stage1_resize_1920_15_500_25'
