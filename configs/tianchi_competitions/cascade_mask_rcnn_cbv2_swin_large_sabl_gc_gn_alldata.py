...
data = dict(
    ...
    val=dict(
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                img_scale=[(2048, 800), (2048, 900), (2048, 1000),
                           (2048, 1100), (2048, 1200), (2048, 1300),
                           (2048, 1400)],
                flip=True,
                transforms=[
                    dict(type='Resize', keep_ratio=True),
...
fp16 = None
gpu_ids = range(0, 4)
work_dir = './work_dirs/cascade_mask_rcnn_cbv2_swin_large_sabl_gc_gn_alldata_simmim_drop0.3'
