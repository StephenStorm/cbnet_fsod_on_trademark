import torch, random
from mmdet.datasets.pipelines.augmentation import *
...
def policy_vtest():
    policy = [SubPolicy('TranslateX_BBox', 0.0, 4,           'Equalize', 1.0, None)]
    return policy
...
def policy_v2():
    policy = [SubPolicy3('Color', 0.0, 6,                    'Cutout', 0.6, 8,                 'Sharpness', 0.4, 8),
              SubPolicy3('Rotate_BBox', 0, 8,              'Sharpness', 0.4, 2,              'Rotate_BBox', 0, 10),
              SubPolicy('TranslateY_BBox', 0, 8,           'AutoContrast', 0.8, None),
              SubPolicy3('AutoContrast', 0.4, None,          'ShearX_BBox', 0, 8,            'Brightness', 0.0, 10),
              SubPolicy3('SolarizeAdd', 0.2, 6,              'Contrast', 0.0, 10,              'AutoContrast', 0.6, None),
              SubPolicy3('Cutout', 0.2, 0,                   'Solarize', 0.8, 8,               'Color', 1.0, 4),
              SubPolicy3('TranslateY_BBox', 0.0, 4,          'Equalize', 0.6, None,            'Solarize', 0.0, 10),
              SubPolicy3('TranslateY_BBox', 0, 2,          'ShearY_BBox', 0, 8,            'Rotate_BBox', 0, 8),
              SubPolicy3('Cutout', 0.8, 8,                   'Brightness', 0.8, 8,             'Cutout', 0.2, 2),
              SubPolicy3('Color', 0.8, 4,                    'TranslateY_BBox', 0, 6,        'Rotate_BBox', 0, 6),
              SubPolicy3('Rotate_BBox', 0, 10,             'BBox_Cutout', 1.0, 4,            'Cutout', 0.2, 8),
              SubPolicy3('Rotate_BBox', 0.0, 0,              'Equalize', 0.6, None,            'ShearY_BBox', 0, 8),
              SubPolicy3('Brightness', 0.8, 8,               'AutoContrast', 0.4, None,        'Brightness', 0.2, 2),
              SubPolicy3('TranslateY_BBox', 0, 8,          'Solarize', 0.4, 6,               'SolarizeAdd', 0.2, 10),
              SubPolicy3('Contrast', 1.0, 10,                'SolarizeAdd', 0.2, 8,            'Equalize', 0.2, None)]
    return policy
