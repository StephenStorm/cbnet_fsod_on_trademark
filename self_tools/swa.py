...
if __name__ == '__main__':
    model_dir = '/opt/tiger/haggs/CBNetV2/work_dirs/cascade_mask_rcnn_cbv2_swin_base_cp_mixup0.5_affine_freeze_stage1_resize'
    model_names = ['epoch_6.pth','epoch_12.pth']
